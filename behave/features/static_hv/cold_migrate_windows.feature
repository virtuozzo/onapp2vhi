...
Scenario: Cold migration without user's SSH key
  ...
  When I migrate the virtual machine (windows-vm-without-startup-static1)
...
Scenario: Cold migration with user's SSH key
  ...
  And I migrate the virtual machine (windows-vm-without-startup-static1)
  Then I wait for 10 seconds
  And I should see the virtual machine (windows-vm-without-startup-static1) is SHUTOFF in VHI portal
  And the virtual machine (windows-vm-without-startup-static1) should have correct CPU, RAM and storage
...
Scenario: Cold migration with user's SSH key with storage policy and placement specified
  ...
  And I create a virtual machine (windows-vm-without-startup-static1)
  Then CP API (create) should return status code 201
  And I wait for 10 minutes
  And the virtual machine (windows-vm-without-startup-static1) is built successfully
  ...
  And I should see the virtual machine (windows-vm-without-startup-static1) is SHUTOFF in VHI portal
  And the virtual machine (windows-vm-without-startup-static1) should have correct CPU, RAM and storage
  And the virtual machine (windows-vm-without-startup-static1) is using the correct storage policy (behave-storage-policy) in its volume
  And the virtual machine (windows-vm-without-startup-static1) is placed in the corrent placement (behave-soft-placement)
...
Scenario: Cold migration with user's SSH key with second network interface (IPv4)
  ...
  When I add a network interface (behave-network-interface-ipv4) with network join (behave-network-join-993) at compute zone (Static Compute Zone) to the virtual machine (windows-vm-without-startup-static1)
  Then CP API (create) should return status code 201

  When I add an IP address (behave-ip-net-ipv4) from network (behave-network-ipv4) to the network interface (behave-network-interface-ipv4) on virtual machine (windows-vm-without-startup-static1)
  Then CP API (create) should return status code 201

  When I reboot the virtual machine (windows-vm-without-startup-static1) in Onapp cloud
  Then CP API (reboot) should return status code 201
  And I wait for 90 seconds

  When I shutdown the virtual machine (windows-vm-without-startup-static1) in Onapp cloud
...
Scenario: Cold migration with user's SSH key with second network interface (IPv4 and IPv6)
  ...
  When I add a network interface (behave-network-interface-ipv4-ipv6) with network join (behave-network-join-997) at compute zone (Static Compute Zone) to the virtual machine (windows-vm-without-startup-static1)
  Then CP API (create) should return status code 201

  When I add an IP address (behave-ip-net-ipv4) from network (behave-network-ipv4-ipv6) to the network interface (behave-network-interface-ipv4-ipv6) on virtual machine (windows-vm-without-startup-static1)
  Then CP API (create) should return status code 201
  
  When I add an IP address (behave-ip-net-ipv6) from network (behave-network-ipv4-ipv6) to the network interface (behave-network-interface-ipv4-ipv6) on virtual machine (windows-vm-without-startup-static1)
  Then CP API (create) should return status code 201
