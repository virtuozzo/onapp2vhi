...
Scenario: Cold migration without user's SSH key
  ...
  And I migrate the virtual machine (linux-vm-without-startup-static)
...
Scenario: Cold migration with user's SSH key with storage policy specified
  ...
  And I create a virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201
  And I wait for 2 minutes
  And the virtual machine (linux-vm-without-startup-static) is built successfully

  When I migrate the virtual machine (linux-vm-without-startup-static) with following details
  | storage policy        |
...
Scenario: Cold migration with user's SSH key with second network interface (IPv4)
  ...
  When I add a network interface (behave-network-interface-ipv4) with network join (behave-network-join-993) at compute zone (Static Compute Zone) to the virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201

  When I add an IP address (behave-ip-net-ipv4) from network (behave-network-ipv4) to the network interface (behave-network-interface-ipv4) on virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201
...
Scenario: Cold migration with user's SSH key with second network interface (IPv6)
  ...
  When I add a network interface (behave-network-interface-ipv6) with network join (behave-network-join-994) at compute zone (Static Compute Zone) to the virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201

  When I add an IP address (behave-ip-net-ipv6) from network (behave-network-ipv6) to the network interface (behave-network-interface-ipv6) on virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201
...
Scenario: Cold migration with user's SSH key with second network interface (IPv4 and IPv6)
  ...
  When I add a network interface (behave-network-interface-ipv4-ipv6) with network join (behave-network-join-997) at compute zone (Static Compute Zone) to the virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201

  When I add an IP address (behave-ip-net-ipv4) from network (behave-network-ipv4-ipv6) to the network interface (behave-network-interface-ipv4-ipv6) on virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201
  
  When I add an IP address (behave-ip-net-ipv6) from network (behave-network-ipv4-ipv6) to the network interface (behave-network-interface-ipv4-ipv6) on virtual machine (linux-vm-without-startup-static)
  Then CP API (create) should return status code 201
