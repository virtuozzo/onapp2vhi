...
expect -exact "\r
\[root@recovery ~\]# "
send -- "mv -f /sysroot/tmplroot/* /sysroot/"
send -- "\r"
expect -exact "\r
\[root@recovery ~\]# "
...
expect -exact "\r
\[root@recovery ~\]# "
send -- "/bin/cp -rf /mnt/enabledhcp.sh /sysroot/root/EnableDHCP.sh\r"
send -- "\r"
expect -exact "\r
\[root@recovery ~\]# "
...
expect -exact "\r
\[root@recovery ~\]# "
send -- "chroot /sysroot /bin/bash  /root/RegenerateUUID.sh\r"
expect "#"
send -- "chroot /sysroot /bin/bash  /root/EnableDHCP.sh\r"
expect "#"
