...
def get_virtual_server_hypervisor(cfg: OnApp2VHIConfig, virtual_server_id: str) -> str:
    """
...
def get_hypervisor_group_id(cfg: OnApp2VHIConfig, hypervisor_id: str) -> str:
    request_handler = OnAppRequests(cfg)
...
def get_hypervisor_network_join(cfg: OnApp2VHIConfig, hypervisor_id: str, network_join_id: str) -> str:
    """
...
def get_virtual_server_interfaces(cfg: OnApp2VHIConfig, virtual_server_id: str) -> List[Dict[str, str]]:
    """
...
def get_virtual_server_ip_addresses(cfg: OnApp2VHIConfig, virtual_server_id: str, network_interface_id: str) -> List:
    """
...
def get_network_nameserver(cfg: OnApp2VHIConfig, network_id: str, ipv4=True) -> str:
    """
...
def get_network_interfaces(cfg: OnApp2VHIConfig, virtual_server_id: str):
    """
...
def get_ip_net(cfg: OnApp2VHIConfig, network_id: str, ip_net_id: str):
...
def get_ip_range(cfg: OnApp2VHIConfig, network_id: str, ip_net_id: str, ip_range_id: str) -> Dict:
    """
...
def get_network_id_by_identifier(cfg: OnApp2VHIConfig, identifier: str) -> str:
    """
...
def get_vm_network_info(cfg: OnApp2VHIConfig, vm_identifier: str = '') -> dict:
    nics = get_virtual_server_interfaces(cfg, virtual_server_id=vm_identifier)
    network_info = {}
    for nic in nics:
        _nic_id = nic["network_interface"]["id"]
        _ip_addrs = get_virtual_server_ip_addresses(cfg,
                                                    virtual_server_id=vm_identifier,
